    ...
    stream = (gyroscope ?? gyroscopeEvents)
      ...
      (listOfPairs) {
        ...
        for (var i = 0; i < length; i++) {
          final g1 = listOfPairs[i][0] as GyroscopeEvent;
          final a1 = listOfPairs[i][1] as AccelerometerEvent;
          g = GyroscopeEvent(g.x + g1.x, g.y + g1.y, g.z + g1.z);
          a = AccelerometerEvent(a.x + a1.x, a.y + a1.y, a.z + a1.z);
        }
        g = GyroscopeEvent(g.x / length, g.y / length, g.z / length);
        a = AccelerometerEvent(a.x / length, a.y / length, a.z / length);
...
class Tilt {
  ...
  double get xDegrees => ((xRadian * 180 / pi)).abs();
